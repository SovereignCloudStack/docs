...
const Caret = () => {
  return (
    <span className="caret animate-caret inline-block h-[15px] w-[8px] translate-y-[2px] translate-x-[2px] transform rounded-[1px] bg-blue-600 shadow-[0_0px_3px_0px_rgba(37,99,235,0.9)]" />
  );
};
