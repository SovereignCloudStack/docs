        ...
        headTags: [
          ...
          },
          {
            ...
            innerHTML: `
                ...
                ${
                  matomoAnalytics.cookieDomain
                    ? `_paq.push(["setCookieDomain", "${matomoAnalytics.cookieDomain}"]);`
                    : ''
                }
                ${
                  matomoAnalytics.domains
                    ? `_paq.push(["setDomains", ["${matomoAnalytics.domains}"]])`
                    : ''
                }
                ${
                  matomoAnalytics.campaignNameKey
                    ? `_paq.push(["setCampaignNameKey", "${matomoAnalytics.campaignNameKey}"]);`
                    : ''
                }
                ${
                  matomoAnalytics.campaignKeywordKey
                    ? `_paq.push(["setCampaignKeywordKey", "${matomoAnalytics.campaignKeywordKey}"]);`
                    : ''
                }
                ${
                  matomoAnalytics.doNotTrack
                    ? `_paq.push(["setDoNotTrack", ${matomoAnalytics.doNotTrack}]);`
                    : ''
                }
                ${
                  matomoAnalytics.disableCookies
